...
public final class ShopMenu extends CustomMenu {
    ...
    public Inventory getInventory(User u) {
        setItem(new ItemBuilder(Material.YELLOW_FLOWER).setTitle("&8>> &7Posiadasz &e" + u.getCoins() + " &7coinsow! &8<<").addEnchantment(Enchantment.DURABILITY, 10).addItemFlag(ItemFlag.HIDE_ENCHANTS).build(), 21);
